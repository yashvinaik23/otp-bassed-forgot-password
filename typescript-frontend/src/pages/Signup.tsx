...
import { SignUpUser, signUpUserWithGoogle } from "../Actions/loginAction";

const Signup = () => {
  const dispatch = useDispatch<AppDispatch>();

  const { user, loginInProgress } = useSelector(
            ...
            <form onSubmit={onSubmitHandler}>
              ...
              <div className="w-full flex items-center justify-center mb-5">
                <button
                  type="button"
                  onClick={() => login()}
                  className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 lg:w-1/2 lg:flex lg:justify-evenly"
                >
                  <svg
